...
<body>
    <div class="wrapper">
        ...
        <div class="container" style="text-align: center;">
            <h4 style="margin-bottom: 50px;">Welcome to Ten to Thousand! Please Register.</h4>
        </div>
      ...
      ?>
            ...
            <form action="register.php" method="post">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <button type="submit" class="primary-btn" style="border: 0px;width:100%" name="signup"><i
